                        ...
                        <div className="flex flex-col gap-[6px]">
                            <div className="flex items-center gap-1">
                                {[...Array(5)].map((_, index) => {
                                    ...
                                    let starSrc = "/assets/images/icons/Star 5.svg"; // default: kosong

                                    if (office.rating >= ratingValue) {
                                        starSrc = "/assets/images/icons/Star 1.svg"; // penuh
                                    } else if (office.rating >= ratingValue - 0.5) {
                                        starSrc = "/assets/images/icons/Star 3.svg"; // setengah (jika ada)
                                    }
